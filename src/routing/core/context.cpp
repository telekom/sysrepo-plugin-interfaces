 ...
 *
 */
std::shared_ptr<OperContext> PluginContext::getOperContext() const {
    return m_operCtx;
}
 ...
 *
 */
std::shared_ptr<ModuleChangeContext> PluginContext::getModuleChangeContext() const {
    return m_changeCtx;
}
 ...
 *
 */
std::shared_ptr<RpcContext> PluginContext::getRpcContext() const {
    return m_rpcCtx;
}
 ...
 *
 */
std::shared_ptr<NotifContext> PluginContext::getNotifContext() const {
    return m_notifCtx;
}
