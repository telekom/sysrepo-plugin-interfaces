...
#include <sysrepo.h>
#include <core/system/ChangeMethods.cpp>
 ...
 *
 */
InterfaceModuleEnabledChangeCb::InterfaceModuleEnabledChangeCb(std::shared_ptr<InterfacesModuleChangesContext> ctx) { m_ctx = ctx; }
...
InterfaceModuleNameChangeCb::InterfaceModuleNameChangeCb(std::shared_ptr<InterfacesModuleChangesContext> ctx) { m_ctx = ctx; }
InterfaceModuleTypeChangeCb::InterfaceModuleTypeChangeCb(std::shared_ptr<InterfacesModuleChangesContext> ctx) { m_ctx = ctx; }
InterfaceModuleIPV4EnableChangeCb::InterfaceModuleIPV4EnableChangeCb(std::shared_ptr<InterfacesModuleChangesContext> ctx) { m_ctx = ctx; }
InterfaceModuleIPV4MtuChangeCb::InterfaceModuleIPV4MtuChangeCb(std::shared_ptr<InterfacesModuleChangesContext> ctx) { m_ctx = ctx; }
InterfaceModuleIPV4AddressChangeCb::InterfaceModuleIPV4AddressChangeCb(std::shared_ptr<InterfacesModuleChangesContext> ctx) { m_ctx = ctx; }
InterfaceModuleIPV4PrefixChangeCb::InterfaceModuleIPV4PrefixChangeCb(std::shared_ptr<InterfacesModuleChangesContext> ctx) { m_ctx = ctx; }
InterfaceModuleIPV4NeighbourIpChangeCb::InterfaceModuleIPV4NeighbourIpChangeCb(std::shared_ptr<InterfacesModuleChangesContext> ctx) { m_ctx = ctx; }
InterfaceModuleIPV4NeighbourLLAddressChangeCb::InterfaceModuleIPV4NeighbourLLAddressChangeCb(std::shared_ptr<InterfacesModuleChangesContext> ctx)
{
    m_ctx = ctx;
}
InterfaceModuleIPV6ChangeCb::InterfaceModuleIPV6ChangeCb(std::shared_ptr<InterfacesModuleChangesContext> ctx) { m_ctx = ctx; }
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
