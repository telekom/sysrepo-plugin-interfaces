...
public:
     ...
     *
     */
    InterfaceModuleEnabledChangeCb(std::shared_ptr<InterfacesModuleChangesContext> ctx);
...
public:
    InterfaceModuleNameChangeCb(std::shared_ptr<InterfacesModuleChangesContext> ctx);
...
public:
    InterfaceModuleTypeChangeCb(std::shared_ptr<InterfacesModuleChangesContext> ctx);
...
public:
    InterfaceModuleIPV4EnableChangeCb(std::shared_ptr<InterfacesModuleChangesContext> ctx);
...
public:
    InterfaceModuleIPV4MtuChangeCb(std::shared_ptr<InterfacesModuleChangesContext> ctx);
...
public:
    InterfaceModuleIPV4AddressChangeCb(std::shared_ptr<InterfacesModuleChangesContext> ctx);
...
public:
    InterfaceModuleIPV4PrefixChangeCb(std::shared_ptr<InterfacesModuleChangesContext> ctx);
...
public:
    InterfaceModuleIPV4NeighbourIpChangeCb(std::shared_ptr<InterfacesModuleChangesContext> ctx);
...
public:
    InterfaceModuleIPV4NeighbourLLAddressChangeCb(std::shared_ptr<InterfacesModuleChangesContext> ctx);
...
public:
    InterfaceModuleIPV6ChangeCb(std::shared_ptr<InterfacesModuleChangesContext> ctx);
